...
import 'package:pay_flow_flutter/app/modules/home/widgets/home_shimmer.dart';
                    ...
                    FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (snapshot.connectionState == ConnectionState.done) {
                          return TicketsTiles(tickets: store.unpaindTickets, onTap: true);
                        }
